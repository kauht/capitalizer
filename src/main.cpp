...
.titlebar { flex: none; height: 50px; display: flex; align-items: center;
  padding: 0 8px 0 15px; gap: 12px; background: rgba(22,22,27,0.30); }
.tb-icon { width: 28px; height: 28px; border-radius: 8px; flex: none; }
.tb-name { flex: 1; font-size: 13.5px; font-weight: 600; color: #dcdce2; letter-spacing: .2px; }
.wc { display: flex; gap: 2px; }
.wc-btn { width: 32px; height: 30px; display: grid; place-items: center; border-radius: 6px;
...
.panel { flex: 1 1 auto; min-height: 0; display: flex; flex-direction: column;
  padding: 12px 22px 16px; background: rgba(22,22,27,0.30); }
