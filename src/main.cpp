...
.titlebar { flex: none; height: 34px; display: flex; align-items: center;
  padding: 0 6px 0 14px; gap: 10px; background: rgba(22,22,27,0.30); }
.tb-name { flex: 1; font-size: 12px; font-weight: 600; color: #c6c6cf; letter-spacing: .3px; }
.wc { display: flex; gap: 2px; }
.wc-btn { width: 30px; height: 24px; display: grid; place-items: center; border-radius: 6px;
  color: #b6b6c0; cursor: pointer; transition: background .12s, color .12s; }
.wc-btn:hover { background: rgba(255,255,255,0.09); color: #fff; }
.wc-btn.close:hover { background: #e2453a; color: #fff; }
.wc-btn svg { width: 10px; height: 10px; display: block; }
.panel { flex: 1 1 auto; min-height: 0; display: flex; flex-direction: column;
  padding: 16px 22px 16px; background: rgba(22,22,27,0.30); }
.header { margin-bottom: 12px; display: flex; align-items: center; gap: 14px; }
.logo { width: 46px; height: 46px; border-radius: 12px; flex: none; }
.subtitle { font-size: 12.5px; color: #a6a6b1; line-height: 1.4; }
...
<div class="titlebar" id="titlebar">
  ...
  <div class="wc">
    <div class="wc-btn" id="min" title="Minimize"><svg viewBox="0 0 10 10"><line x1="1" y1="5" x2="9" y2="5" stroke="currentColor" stroke-width="1.3"/></svg></div>
    <div class="wc-btn close" id="close" title="Close"><svg viewBox="0 0 10 10"><line x1="1.5" y1="1.5" x2="8.5" y2="8.5" stroke="currentColor" stroke-width="1.3"/><line x1="8.5" y1="1.5" x2="1.5" y2="8.5" stroke="currentColor" stroke-width="1.3"/></svg></div>
  </div>
</div>
<div class="panel">
  <div class="header">
