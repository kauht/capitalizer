...
.titlebar { flex: none; height: 58px; display: flex; align-items: center;
  padding: 0 10px 0 16px; gap: 13px; background: rgba(22,22,27,0.30); }
.tb-icon { width: 36px; height: 36px; border-radius: 9px; flex: none; }
.tb-name { flex: 1; display: flex; align-items: center; font-size: 14.5px; font-weight: 600;
  color: #ededf2; letter-spacing: .2px; }
.wc { display: flex; align-items: center; gap: 3px; }
.wc-btn { width: 40px; height: 36px; display: grid; place-items: center; border-radius: 7px;
  color: #c4c4ce; cursor: pointer; transition: background .12s, color .12s; }
.wc-btn:hover { background: rgba(255,255,255,0.10); color: #fff; }
.wc-btn.close:hover { background: #e2453a; color: #fff; }
.wc-btn svg { width: 13px; height: 13px; display: block; }
...
.statusbar { flex: none; display: flex; align-items: center; gap: 10px;
  padding: 7px 10px 7px 16px; border-top: 1px solid rgba(255,255,255,0.06);
  background: rgba(255,255,255,0.02); }
.hint { flex: 1; font-size: 11.5px; color: #7c7c86; }
.action { display: inline-flex; align-items: center; gap: 8px; font-family: inherit;
  font-size: 12.5px; font-weight: 500; color: #e6e6ea; background: transparent; border: none;
  padding: 5px 7px 5px 10px; border-radius: 7px; cursor: pointer; transition: background .12s; }
.action:hover { background: rgba(255,255,255,0.09); }
.kbd { display: inline-grid; place-items: center; min-width: 21px; height: 21px; padding: 0 5px;
  font-size: 12px; color: #d0d0d8; background: rgba(255,255,255,0.09);
  border: 1px solid rgba(255,255,255,0.11); border-radius: 6px; box-shadow: 0 1px 0 rgba(0,0,0,0.25); }
</style></head><body>
...
<div class="statusbar">
  ...
  <button class="action" id="save">Save <span class="kbd">&#8629;</span></button>
</div>
<script>
...
void ShowSettings() {
    ...
    g_settingsHwnd = CreateWindowExW(WS_EX_APPWINDOW, kSettingsClass, L"Capitalizer",
